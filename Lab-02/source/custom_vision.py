...
class CustomVision():
    def __init__(self):
        ...
        self._publish_iteration_name = "Iteration2"
    ...
    def createProject(self):
        ...
        return self._trainer.create_project(self._settings.get_project_name())
    ...
    def train_project(self, project):
        ...
        try:
            ...
            for iteration in self._trainer.get_iterations(project.id):
...
if __name__ == "__main__":
    cv = CustomVision()
    # project = cv.createProject()
    project = cv.find_project()
    ...
    # cv.train_project(project)

    cv.exportIteration(project.id, "05082bce-9bc0-4a0f-abff-c67768f92e5a")
